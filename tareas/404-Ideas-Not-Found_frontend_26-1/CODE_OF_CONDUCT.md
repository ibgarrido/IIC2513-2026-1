...
Al menos una reunión semanal con horario a deliberar por los miembros del grupo, dado disponibilidad de dicha semana.
...
1. Si **YO** tengo una entrega de otro curso un día de entrega de este proyecto, me comprometo a:- **Avisar con anticipación al equipo** sobre el conflicto de fechas.

- **Planificar mi trabajo con antelación**, adelantando tareas cuando sea posible.  
- **Priorizar responsabilidades críticas del proyecto**, en coordinación con el equipo.  
- **Solicitar apoyo temporal**, si es necesario, para cumplir con ambas exigencias.  
- **Compensar posteriormente**, retomando o asumiendo tareas adicionales cuando mi carga disminuya.
  
   Como equipo, nos comprometemos a:

- **Ser flexibles y comprensivos** frente a la carga académica de los miembros.
    - **Redistribuir tareas de manera temporal**, evitando sobrecargar a una sola persona.  
- **Mantener comunicación constante**, asegurando que todos estén alineados con el progreso del proyecto.  
...
1. Si **YO** tengo un viaje planificado durante lo que queda de semestre, me comprometo a:

- **Informarlo con anticipación al equipo**, indicando fechas exactas de ausencia.
- **Dejar mis tareas adelantadas o encaminadas**, priorizando responsabilidades críticas.
- **Coordinar la redistribución temporal de mis tareas**, en caso de que sea necesario.
- **Mantener cierto nivel de comunicación**, si las condiciones lo permiten.
- **Retomar mis responsabilidades rápidamente** al regresar, ajustándome al estado del proyecto.

En caso de no tener viajes o eventos planificados:  
**Ninguno de los miembros de este equipo reportó tener alguna indisponibilidad prevista.**
...
1. Si **YO** no puedo trabajar porque me pasó algo, me comprometo a:

- **Avisar al equipo lo antes posible**, en la medida de lo posible, sobre mi situación.
- **Ser transparente respecto a mi disponibilidad**, sin necesidad de entrar en detalles personales si no lo deseo.
- **Delegar o dejar indicaciones claras** sobre mis tareas pendientes, si tengo la oportunidad.

Como equipo, se espera que:

- **Se priorice el bienestar de la persona afectada**, entendiendo que hay situaciones fuera del control individual.
- **Se redistribuyan las tareas de forma equitativa** para mantener el avance del proyecto.
- **Se mantenga una comunicación respetuosa y empática** frente a la situación.
- **Se informe al equipo docente si la situación impacta significativamente el progreso**, para dejar respaldo.

**Ejemplo:** enfermedad, accidente, problema familiar urgente u otra situación imprevista que impida continuar trabajando temporalmente.
...
1. Si **como equipo** no tenemos el entregable listo para el día de la entrega, nos comprometemos a:

- **Priorizar un entregable mínimo funcional (MVP)** que cumpla con los requerimientos esenciales.
- **Reorganizar y redistribuir tareas** para cubrir los puntos críticos pendientes.
- **Extender la coordinación interna**, aumentando la frecuencia de reuniones y seguimiento.
- **Evitar bloqueos técnicos**, optando por soluciones más simples si es necesario.
- **Entregar una versión estable y coherente**, aunque no incluya todas las funcionalidades planificadas.
- **Documentar claramente** qué partes fueron completadas y cuáles quedaron pendientes.
...
1. Si **como equipo** no conseguimos respuesta de un miembro para asignar responsabilidades o confirmar que está progresando, nos comprometemos a:

- **Intentar múltiples vías de contacto** (mensajes, correo, plataformas acordadas) dentro de un plazo razonable.
- **Redistribuir sus tareas temporalmente** para no frenar el avance del proyecto.
- **Registrar la situación**, dejando evidencia de los intentos de contacto.
- **Mantener una comunicación transparente dentro del equipo** sobre el estado del miembro.
- **Informar al equipo docente** si la situación persiste, para dejar respaldo formal.
- **Reintegrar al miembro de forma ordenada**, en caso de que retome contacto, ajustando nuevamente las responsabilidades.
...
1. Si **como equipo** no logramos llegar a un acuerdo sobre una decisión de diseño del proyecto, llevaremos a cabo una votación, donde con un quorum de 2/3 se aprobará o rechazará la moción.
...
Si como equipo creemos que podríamos no llegar con el proyecto listo a la última entrega, nos comprometemos a:

- Detectarlo con anticipación, monitoreando el progreso semanalmente y comparándolo con la planificación inicial.
- Reevaluar el alcance del proyecto, priorizando las funcionalidades esenciales (MVP) por sobre características adicionales.
Redistribuir tareas internamente, apoyando a los miembros con mayor carga o dificultades.
- Aumentar la frecuencia de comunicación, realizando reuniones extraordinarias si es necesario.
- Solicitar ayuda oportunamente, ya sea al equipo docente o a otros recursos disponibles, en caso de bloqueos técnicos.
- Asegurar una entrega funcional mínima, aunque no incluya todas las funcionalidades originalmente planificadas, priorizando calidad y estabilidad.
...
1. Si **YO** encuentro código que aparentemente fue desarrollado por una IA pero no se referenció, me comprometo a notificarle a mi compañero por privado para incentivarlo a referenciar lo realizado con sus respectivas fuentes.
...
![Firma Ignacio](assets/firmas/ignacio.png)
![Firma Gustavo](assets/firmas/firma_gustavo.jpg)
![Firma Gaspar](assets/firmas/Firma_Gaspar.jpeg)
